...
class BuscarDevolucion extends StatefulWidget {
  const BuscarDevolucion({Key key}) : super(key: key);

  @override
  _BuscarDevolucionState createState() => _BuscarDevolucionState();
}

class _BuscarDevolucionState extends State<BuscarDevolucion> {
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Text('Seleccione como desea buscar la factura para la devolución',
