...
class DeleteEstablecimiento extends StatefulWidget {
  ...
  @override
  _DeleteEstablecimientoState createState() => _DeleteEstablecimientoState();
}

class _DeleteEstablecimientoState extends State<DeleteEstablecimiento> {
